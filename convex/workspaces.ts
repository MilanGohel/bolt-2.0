...
export const GenerateAIResponse = action({
    ...
    handler: async (ctx, { prompt, history }) => {
        try {
            ...
            if (!response.text) throw new ConvexError("No response from AI");
